...
const (
	Inventory_GetPart_FullMethodName = "/inventory.v1.Inventory/GetPart"
)
...
type InventoryClient interface {
	...
	GetPart(ctx context.Context, in *GetPartRequest, opts ...grpc.CallOption) (*GetPartResponce, error)
}
...
func (c *inventoryClient) GetPart(ctx context.Context, in *GetPartRequest, opts ...grpc.CallOption) (*GetPartResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPartResponce)
	err := c.cc.Invoke(ctx, Inventory_GetPart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServer interface {
	// Возвращает информацию о детали по её UUID.
	GetPart(context.Context, *GetPartRequest) (*GetPartResponce, error)
...
func (UnimplementedInventoryServer) GetPart(context.Context, *GetPartRequest) (*GetPartResponce, error) {
...
func _Inventory_GetPart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServer).GetPart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Inventory_GetPart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).GetPart(ctx, req.(*GetPartRequest))
	}
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetPart",
			Handler:    _Inventory_GetPart_Handler,
		},
	},
